...
BEGIN
  ...
  v := seed_upsert_product(
    ...
    'Premium Jute Bag', 'প্রিমিয়াম জুট ব্যাগ',
    'প্রিমিয়াম কোয়ালিটি জুট ব্যাগ — ইকো-ফ্রেন্ডলি ও মজবুত। শপিং ও গিফটের জন্য টেকসই পছন্দ। প্রাকৃতিক টেক্সচার ও আরামদায়ক হ্যান্ডেল।',
    750, 'home-decor', 'simple', NULL, NULL, 0,
    NULL, 'Jute', 'BD',
    'প্রিমিয়াম জুট ব্যাগ | ALMA',
    'যত্নে বাছাই করা জুট ব্যাগ — টেকসই লাইফস্টাইল পণ্য।'
  );
