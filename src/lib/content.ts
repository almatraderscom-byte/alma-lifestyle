...
export const MURDA_MOSHARI_PAGE = {
  hero: {
    ...
    heading: 'মুসলমানের শেষ গোসলে পর্দা, পরিচ্ছন্নতা ও সম্মানের জন্য',
    subheading: 'স্মার্ট মুর্দা মশারী — মৃত্যুর পরেও মর্যাদা বজায় রাখার একটি পরিপূর্ণ সমাধান',
    primaryCta: 'অর্ডার করতে চাই',
    secondaryCta: 'ফোনে অর্ডার করুন',
    phone: '01307-777733',
    trustItems: [
      'ক্যাশ অন ডেলিভারি',
      'সারাদেশে ডেলিভারি',
  ...
  problem: {
    heading: 'কেন এই মশারী প্রয়োজন?',
    intro: 'মানুষ ইন্তেকালের পর অনেক সময় শাড়ি বা সাধারণ কাপড় দিয়ে ঢেকে গোসল করানো হয়। এতে —',
    points: [
      'সতর ঠিকভাবে ঢাকা থাকে না',
      'কাপড়ে নাপাকি থাকার সম্ভাবনা থাকে',
      'উপর থেকে তাকালে ভেতর দেখা যায়',
    ],
    outro: 'এই সব সমস্যার একটি পরিপূর্ণ সমাধান হলো স্মার্ট মুর্দা মশারী।',
  },
  solution: {
    eyebrow: 'স্মার্ট মুর্দা মশারী',
    heading: 'মহিলাদেরকে পর্দার সাথে শায়িত করতে পারবেন',
    body: 'চারদিক ঢাকা, উপরে নেট দিয়ে বাতাস চলাচলের ব্যবস্থা, আলাদা দরজা — ইসলামিক বিধান অনুযায়ী সম্পূর্ণ পর্দা ও মর্যাদা রক্ষা করে।',
    tags: ['৪ দিকে ঢাকা', 'মেশ টপ', 'আলাদা দরজা'],
  },
  features: {
    heading: 'আমাদের এই কম্বো প্যাকেজে যা যা পাচ্ছেন',
    items: [
      { title: 'চারদিক সম্পূর্ণ ঢাকা', desc: 'ভেতরের কিছুই বাইরে থেকে দেখা যাবে না' },
      { title: 'শ্বাসপ্রশ্বাসের ব্যবস্থা', desc: 'উপরে নেট — বাতাস ও আলো ঢুকবে, কিন্তু দেখা যাবে না' },
      { title: 'আলাদা দরজা সিস্টেম', desc: 'গোসল করানোর জন্য সহজ প্রবেশ' },
      { title: 'মসজিদে দান করার যোগ্য', desc: 'সদকায়ে জারিয়াহ হিসেবে রেখে যেতে পারেন' },
      { title: 'টেকসই প্যাকেজিং', desc: 'চমৎকার ও মজবুত বক্সে ডেলিভারি' },
      { title: 'লম্বা ১০.৫ ফুট', desc: 'পরিপূর্ণ আকার' },
      { title: 'চওড়া ৬.৫ ফুট', desc: 'প্রশস্ত ভেতর' },
  ...
  donation: {
    ...
    heading: 'মসজিদে দান করুন, কিয়ামত পর্যন্ত সওয়াব পান',
    body: 'আপনার এলাকার মসজিদে একটি স্মার্ট মুর্দা মশারী দান করুন। যতদিন এটি ব্যবহার হবে, ততদিন আপনি ও আপনার পরিবার সওয়াব পেতে থাকবেন ইনশাআল্লাহ।',
    cta: 'দান করার জন্য অর্ডার করুন',
  },
  pricing: {
  ...
  reviews: {
    ...
    subheading: 'যাদের পরিবারের শেষ মুহূর্তে আমরা পাশে থেকেছি',
  ...
  trustFooter: {
    ...
    callHours: 'সকাল ৯টা থেকে রাত ১০টা',
    whatsappTitle: 'হোয়াটসঅ্যাপে মেসেজ',
    addressTitle: 'আমাদের অফিস',
    address: 'গ্রীনপ্লেস, অফিস ৬/সি, মাদানি এভিনিউ, গুলশান, ঢাকা-১২১২',
